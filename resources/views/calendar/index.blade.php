    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form>
                    <select class="form-control" id='client_id' name="clients" onchange="showContact()">
                        <option value="" selected disabled>--- Client ---</option>
                        @foreach($calclient as $item)
                            <option value="{{$item->id}}" data-text="{{$item->contact}}">{{$item->nom}}</option>
                        @endforeach
                    </select>
                </form>
                <script>
                    function showContact() {
                        var selectedOption = document.querySelector("#client_id option:checked");
                        var contact = selectedOption.getAttribute("data-text");
                ...
                <br>
                <div>
                    <input type="text" id="contact" value="" class="form-control" placeholder="contact....">
                </div>
                <br>
